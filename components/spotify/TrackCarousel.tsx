...
const customTheme: CustomFlowbiteTheme["carousel"] = {
  ...
  indicators: {
    ...
    wrapper:
      "flex w-full bot-1/2 place-content-center  flex translate-y-20  space-x-3",
  },
      ...
      <div className=" ">
        <Carousel slide={true} theme={customTheme}>
          {tracks?.map((track: Track) => {
            ...
            return (
              <Link
                className="cursor-pointer place-content-center w-full flex"
                key={track.id}
              ...
              >
                <div className=" transition duration-300 bg-paper-500 hover:opacity-80">
                  ...
                  <h3 className="mt-5 text-center font-bold truncate">
                    {track.name}
                  </h3>
